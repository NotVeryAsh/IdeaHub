        ...
        <div class="flex flex-wrap items-center space-x-8 ml-auto p-4">
            ...
            <div id="navbar-default" class="hidden w-full md:block md:w-auto md:relative md:mt-0 absolute top-0 right-0 mt-20 flex-column justify-content-center align-items-center">
                <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border rounded-lg md:flex-row md:space-x-8 md:mt-0 md:border-0 bg-gray-800 md:bg-gray-900 border-gray-700">
                    ...
                    <li>
                        <a href="{{ route('dashboard') }}" class="block py-2 pl-3 pr-4 rounded md:border-0 md:p-0 md:hover:text-blue-500 hover:bg-gray-700 hover:text-white md:hover:bg-transparent @if(request()->routeIs('dashboard')) text-blue-500 @endif">Dashboard</a>
                    </li>
                    <li>
                        <a href="#" class="block py-2 pl-3 pr-4 rounded md:border-0 md:p-0 md:hover:text-blue-500 hover:bg-gray-700 hover:text-white md:hover:bg-transparent @if(request()->routeIs('docs')) text-blue-500 @endif">Docs</a>
                    </li>
                </ul>
            </div>
