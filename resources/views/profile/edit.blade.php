...
@section('content')
    ...
    <form class="w-full max-w-xs mx-auto space-y-8" action="/profile" method="post">
        ...
        <img src="{{ asset('images/idea-hub-logo-minimal.jpg') }}" class="rounded-full w-32 h-32 mt-4 mx-auto" alt="Users' profile picture">

        <div class="flex flex-col items-center justify-center w-full space-y-8">
        <button onclick="toggle($('#profile-picture-upload'));" class="mx-auto bg-blue-500 hover:bg-blue-700 font-bold py-2 px-4 rounded focus:outline-none" type="button">
