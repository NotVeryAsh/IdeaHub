...
@section('content')
    ...
    <div class="flex items-center space-x-8 w-8/12 mx-auto">
        ...
        @if($user->profile_picture)
            <img id="preview-image" src="{{ asset("storage/$user->profile_picture") }}" class="object-cover ring-2 ring-blue-500 rounded-full w-32 h-32 mt-4 mx-auto" alt="User's profile picture" data-original-image="{{ asset("storage/$user->profile_picture") }}">
        @else
